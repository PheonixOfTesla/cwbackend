  ...
  return `
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                <p>Hey ${name},</p>
                <p>Thanks for your interest in partnering with ClockWork. We received a high volume of applications, and at this time, we're unable to move forward with your application.</p>
                <p>This is often due to our current focus on specific niches or audience engagement metrics. We encourage you to continue creating great content.</p>
                ${reason ? `<p><strong>Reason:</strong> ${reason}</p>` : ''}
                <p>The door isn't closed forever. We welcome you to reapply in the future as our program evolves.</p>
                <p>Best regards,</p>
